...
from apps.frontend.views import index_view, login_view, register_view, account_view, confirm_view, \
    ...
    review_view, edit_review_view, edit_category_view, dialogs_view, dialog_view, moderate_view, edit_dormitory_view
...
urlpatterns = [
    ...
    path("account/edit_dormitory/", edit_dormitory_view, name="edit_dormitory"),
